          ...
          <div className="table-wrap">
            <table>
              ...
              <tbody>
                  ...
                  <tr key={u.id}>
                    <td>
                      <div className="flex-center gap-2">
                        ...
                        <span style={{ fontWeight: 700, color: '#2d3436' }}>{u.name}</span>
                      </div>
                    </td>
                    <td className="text-dim text-sm">{u.email}</td>
                    <td>
                ...
                {filtered.length === 0 && (
                  <tr><td colSpan={6} style={{ textAlign: 'center', color: '#b2bec3', padding: 40 }}>No users found</td></tr>
                )}
              </tbody>
            </table>
          </div>
