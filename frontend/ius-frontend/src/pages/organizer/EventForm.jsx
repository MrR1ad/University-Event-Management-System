...
const STATUSES = ['Upcoming', 'Ongoing', 'Cancelled'];
    ...
    if (isEdit) {
      getEventById(Number(id)).then(ev => {
        if (ev) setForm({
          ...
          category: ev.category, startDate: ev.startDate,
          endDate: ev.endDate, capacity: ev.capacity,
      ...
      <div className="card" style={{ maxWidth: 720 }}>
        <form onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input
              placeholder="e.g. AI Workshop Spring 2026"
              value={form.title}
          ...
          <div className="form-group">
            ...
            <textarea
              rows={4}
              placeholder="Describe what this event is about, what participants will learn or do…"
